...
LastEditTime: 2023-05-18 23:19:26
...
active_history= np.load("savedModel/active_learning/new_noise_2d_epochs120_lr_0.001_bs_16_history.npy", allow_pickle=True).item()
...
plt.plot(active_history['acc_test'], label="random sample")
...
plt.plot(active_history['f1_test'], label="Conventional training", linewidth=5)
