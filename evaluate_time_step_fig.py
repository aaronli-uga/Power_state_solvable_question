...
LastEditTime: 2022-10-05 15:29:23
...
r_f1_test = r_t1 + r_t2 + r_t3 + r_t4 + r_t5 + r_t6 + r_t7



# active learning timestamp history
a_t1 = np.load("savedModel/active_learning/4d_1_epochs200_lr_0.001_bs_16_history.npy", allow_pickle=True).item()['f1_test']
a_t2 = np.load("savedModel/active_learning/4d_2_epochs200_lr_0.001_bs_16_history_transfer.npy", allow_pickle=True).item()['f1_test']
a_t3 = np.load("savedModel/active_learning/4d_3_epochs200_lr_0.001_bs_16_history_transfer.npy", allow_pickle=True).item()['f1_test']
a_t4 = np.load("savedModel/active_learning/4d_4_epochs200_lr_0.001_bs_16_history_transfer.npy", allow_pickle=True).item()['f1_test']
a_t5 = np.load("savedModel/active_learning/4d_5_epochs200_lr_0.001_bs_16_history_transfer.npy", allow_pickle=True).item()['f1_test']
a_t6 = np.load("savedModel/active_learning/4d_6_epochs200_lr_0.001_bs_16_history_transfer.npy", allow_pickle=True).item()['f1_test']
a_t7 = np.load("savedModel/active_learning/4d_7_epochs200_lr_0.001_bs_16_history_transfer.npy", allow_pickle=True).item()['f1_test']

a_f1_test = a_t1 + a_t2 + a_t3 + a_t4 + a_t5 + a_t6 + a_t7

plt.figure(figsize=(20, 14))
# plt.title('Test F1 score comparison between proposed method and conventional method', fontsize=30)
plt.plot(r_f1_test, label="conventional method", linewidth=5)
plt.plot(a_f1_test, label="proposed method", linewidth=5)
